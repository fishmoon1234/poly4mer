...
def get_parser(parser=None):
    ...
    parser.add_argument(
        "--c_tig", type=float, default=10, help="coefficient for tig loss"
    )
    parser.add_argument(
        "--c_qpua", type=float, default=1, help="coefficient for qpua loss"
    )
    parser.add_argument(
        "--c_sea", type=float, default=0.1, help="coefficient for sea loss"
    )
    parser.add_argument(
        "--c_co", type=float, default=0.01, help="coefficient for co loss"
    )
    parser.add_argument(
        "--smiles_idx", type=int, default=0, help="index for the selected smile."
    )
    parser.add_argument(
        "--local_rank",
        type=int,
    ...
    parser.add_argument(
        "--max_epochs", type=int, required=False, default=2, help="max number of epochs"
    )
    ...
    parser.add_argument("--model_path_tig", type=str, default="./smi_ted/")
    parser.add_argument("--ckpt_filename_tig", type=str, default="smi_ted_Light_40.pt")
    parser.add_argument("--model_path_qpua_pk", type=str, default="./smi_ted/")
    parser.add_argument("--ckpt_filename_qpua_pk", type=str, default="smi_ted_Light_40.pt")
    parser.add_argument("--model_path_sea", type=str, default="./smi_ted/")
    parser.add_argument("--ckpt_filename_sea", type=str, default="smi_ted_Light_40.pt")
    parser.add_argument("--model_path_co", type=str, default="./smi_ted/")
    parser.add_argument("--ckpt_filename_co", type=str, default="smi_ted_Light_40.pt")
